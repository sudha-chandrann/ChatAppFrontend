    ...
    <div className="flex flex-col items-center justify-center w-full h-screen bg-gray-900 p-8">
      ...
      <div className="relative w-64 h-64">
        ...
        {[...Array(12)].map((_, i) => (
          <div 
            key={i}
            className="absolute w-2 h-2 rounded-full bg-indigo-400 orbital-particle"
            style={{
              left: '50%',
              top: '50%',
        ...
        <div 
          className="absolute left-1/2 top-1/2 w-48 h-48 border-4 border-t-purple-500 border-r-indigo-500 border-b-blue-500 border-l-violet-500 rounded-full -translate-x-1/2 -translate-y-1/2 spinning-ring"
        />
      ...
      <div className="w-64 h-2 bg-gray-800 rounded-full mt-12 overflow-hidden">
        <div 
          className="h-full bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-500 transition-all duration-75 ease-out"
