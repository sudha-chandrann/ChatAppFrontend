...
import { RiImageAddLine, RiCloseLine, RiMailLine, RiLockLine, RiUserLine, RiEyeLine, RiEyeOffLine } from "react-icons/ri";
...
function Register() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-900 via-indigo-950 to-gray-900 text-gray-100 flex items-center justify-center py-12">
                ...
                >
                  {uploadphoto ? (
                    <div className="flex items-center justify-between w-full">
                      <div className="truncate max-w-[85%] text-indigo-200">{uploadphoto.name}</div>
                      <button 
                        type="button"
                    ...
                    <>
                      <RiImageAddLine size={24} className="text-indigo-400 group-hover:text-cyan-400 transition-colors" />
                      <span className="group-hover:text-cyan-300 transition-colors">Upload profile picture</span>
                    </>
                  )}
                </label>
                <input 
