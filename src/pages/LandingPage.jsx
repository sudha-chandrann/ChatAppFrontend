    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <header className="fixed w-full bg-gray-900 bg-opacity-90 backdrop-blur-sm z-50 px-6 py-4 border-b border-gray-800 flex justify-between items-center">
        ...
        <div className='hidden md:flex items-center justify-center gap-2'>
            <button className="bg-white hover:bg-white/80 text-black font-bold py-2 px-4 rounded" onClick={()=>{router('/register')}}>
              Sign Up
            </button>
            <button
            className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded" onClick={()=>{router('/login')}}>
              Log In
            </button>
        </div>
      ...
      >
        <div className={`w-full md:w-1/2 transform text-center md:text-left transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <button className="px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg font-medium hover:opacity-90 transform transition hover:-translate-y-1 shadow-lg shadow-purple-900/20" onClick={()=>{router('/register')}}>
              Get Started
            </button>
            <button className="px-8 py-3 bg-gray-800 border border-gray-700 rounded-lg font-medium hover:bg-gray-700 transform transition hover:-translate-y-1" onClick={()=>{router('/login')}}>
              Learn More
            </button>
          </div>
        </div>
